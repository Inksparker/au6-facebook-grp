    ...
    <div className="flex flex-col">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-violet-50 to-white py-24 sm:py-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="mb-6 inline-flex items-center rounded-full border border-violet-200 bg-white px-3 py-1 text-sm font-medium text-violet-700 shadow-sm">
            ...
            <h1 className="max-w-4xl text-5xl font-extrabold tracking-tight text-slate-900 sm:text-7xl">
              Automate Your Business. <span className="text-violet-600 underline decoration-violet-200 underline-offset-8">Focus on Your Passion.</span>
            </h1>
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
              <Link to="/signup">
                <Button size="lg" className="h-12 rounded-full bg-violet-600 px-8 text-lg hover:bg-violet-700 shadow-lg shadow-violet-100">
                  Start Your Automation Journey
                </Button>
              </Link>
              <Link to="/pricing">
                <Button variant="outline" size="lg" className="h-12 rounded-full border-violet-200 px-8 text-lg hover:bg-violet-50">
                  View Business Plans
                </Button>
              </Link>
            </div>
          ...
          >
            <div className="flex flex-col items-center">
              <div className="mb-2 rounded-2xl bg-white p-4 shadow-xl shadow-violet-100">
                <Rocket className="h-8 w-8 text-violet-600" />
              </div>
              <span className="font-semibold text-slate-900">Idea Lab</span>
            </div>
            <div className="flex flex-col items-center">
              <div className="mb-2 rounded-2xl bg-white p-4 shadow-xl shadow-cyan-100">
                <Target className="h-8 w-8 text-cyan-600" />
              </div>
              <span className="font-semibold text-slate-900">Lead Gen</span>
            </div>
            <div className="flex flex-col items-center">
              <div className="mb-2 rounded-2xl bg-white p-4 shadow-xl shadow-blue-100">
                <Users className="h-8 w-8 text-blue-600" />
              </div>
              <span className="font-semibold text-slate-900">CRM & Sales</span>
            </div>
            <div className="flex flex-col items-center">
              <div className="mb-2 rounded-2xl bg-white p-4 shadow-xl shadow-emerald-100">
                <MessageSquare className="h-8 w-8 text-emerald-600" />
              </div>
              <span className="font-semibold text-slate-900">Support</span>
            </div>
            <div className="flex flex-col items-center">
              <div className="mb-2 rounded-2xl bg-white p-4 shadow-xl shadow-amber-100">
                <Receipt className="h-8 w-8 text-amber-600" />
              </div>
              <span className="font-semibold text-slate-900">Bookkeeping</span>
            </div>
            <div className="flex flex-col items-center">
              <div className="mb-2 rounded-2xl bg-white p-4 shadow-xl shadow-slate-100">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              ...
              <ul className="mt-8 space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-center space-x-3 text-slate-700">
                    <div className="flex-shrink-0 rounded-full bg-violet-100 p-1">
            ...
            <div className="relative">
              <div className="absolute -inset-4 rounded-3xl bg-gradient-to-tr from-violet-100 to-violet-50 blur-2xl opacity-50"></div>
      ...
      <section className="bg-violet-600 py-16 sm:py-24">
        <div className="container mx-auto px-4 text-center text-white sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex justify-center space-x-4">
            <Link to="/signup">
              <Button size="lg" className="h-12 bg-white px-8 text-violet-600 hover:bg-violet-50">
                Start Free Trial
              </Button>
            </Link>
          </div>
      ...
      <footer className="border-t bg-slate-50 py-12">
        <div className="container mx-auto px-4 text-center sm:px-6 lg:px-8">
          <div className="flex items-center justify-center space-x-2 text-violet-600 font-bold mb-4">
             <Briefcase className="h-6 w-6" />
             <span>BoostaBizFlow</span>
          </div>
